    ...
    >
      ...
      {useArt ? (
        ...
        <svg
          ...
          className="relative"
          style={{
            color: silhouette ? '#2a1b47' : color,
            filter: silhouette ? 'none' : `drop-shadow(0 4px 12px ${auraColor}55)`,
          }}
          role="img"
        >
          <Body />
  ...
  return (
    <div className="relative inline-flex items-center justify-center" style={{ width: size, height: size * 1.2 }}>
      <svg viewBox="0 0 100 100" width={size} height={size * 1.2} aria-hidden>
        ...
        <path d="M30 84 q7 10 14 2 q7 -9 14 2 q7 10 12 -2 L70 78 L30 78 Z" fill="#2a1b47" />
      </svg>
